            ...
            VerifierDuty::VerifyAssertions {
                ...
                let connector_leaf = {
                    ...
                    let public_inputs = (
                        ...
                        bitcoin::BlockHash::from_byte_array(superblock_hash.parse()),
                        bitcoin::Txid::from_byte_array(bridge_out_txid.parse()),
                        u32::from_be_bytes(superblock_period_start_ts.parse()),
                    );
...
mod tests {
    use bitcoin::{
        absolute::LockTime, opcodes::all::OP_EQUALVERIFY, transaction::Version, Amount, OutPoint,
    ...
    fn mock_assertions() -> Assertions {
        Assertions {
            ...
            superblock_period_start_ts: [0, 0, 0, 0],
            groth16: (
                [[
