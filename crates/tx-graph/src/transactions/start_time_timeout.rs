...
use super::{
    super::{
        connectors::{connector::*, connector_2::Connector2, connector_k::ConnectorK},
...
impl StartTimeTimeoutTransaction {
    ...
    pub fn new_for_validation(
        ...
        let connector_1 = ConnectorK::new(
            network,
    ...
    pub fn num_blocks_timelock_1(&self) -> u32 {
        self.connector_1.num_blocks_timelock_1
    }

    pub fn num_blocks_timelock_2(&self) -> u32 {
        self.connector_1.num_blocks_timelock_2
    }
