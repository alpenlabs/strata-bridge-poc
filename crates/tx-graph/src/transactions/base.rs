...
mod tests {
    ...
    use musig2::{secp256k1::schnorr::Signature, PubNonce};
    use strata_bridge_contexts::base::generate_keys_from_secret;

    use super::verify_public_nonces;
    use crate::transactions::{
        pre_signed_musig2::get_nonce_message, signing_musig2::generate_nonce,
    };

    const DUMMY_TXID: &str = "5df6e0e2761359d30a8275058e299fcc0381534545f55cf43e41983f5d4c9456";

    #[allow(clippy::type_complexity)] // HACK:
    fn get_test_nonces() -> (
