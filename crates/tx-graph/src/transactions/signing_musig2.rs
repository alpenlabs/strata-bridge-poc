...
use strata_bridge_contexts::{base::BaseContext, verifier::VerifierContext};
...
// TODO: This is currently unused and can be removed. If the conversion at the start of the above
// functions is incorrect, try this approach. pub fn to_point(public_key: PublicKey) -> Point {
//     Point::from_slice(&public_key.to_bytes()).unwrap() // TODO: Add error handling. Also, verify
// this method is correct (otherwise see conversion via secp256k1::PublicKey). }
