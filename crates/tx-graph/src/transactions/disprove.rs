...
use crate::{
    connectors::{connector::*, connector_a0::ConnectorA0, connector_a1::ConnectorA1},
    graphs::base::*,
    scripts::*,
};
...
pub struct DisproveTransaction {
    ...
    connector_a1: ConnectorA1,
    connector_a0: ConnectorA0,
...
impl DisproveTransaction {
    ...
    pub fn new_for_validation(
        ...
        let connector_a1 = ConnectorA1::new(network, operator_taproot_public_key);

        let input_0_leaf = 1;
        let _input_0 = connector_a0.generate_taproot_leaf_tx_in(input_0_leaf, &input_0);

        let input_1_leaf = script_index;
        let _input_1 = connector_a1.generate_taproot_leaf_tx_in(input_1_leaf, &input_1);

        let total_output_amount = input_0.amount + input_1.amount - Amount::from_sat(FEE_AMOUNT);

        let equivocation_output = TxOut {
        ...
        DisproveTransaction {
            tx: Transaction {
                ...
                output: vec![equivocation_output, reward_output],
            },
            prev_outs: vec![
                TxOut {
            ...
            prev_scripts: vec![
                connector_a0.generate_taproot_leaf_script(input_0_leaf),
                connector_a1.generate_taproot_leaf_script(input_1_leaf),
            ],
            connector_a1,
            connector_a0,
    ...
    fn finalize_input_0(&mut self, context: &dyn BaseContext) {
        ...
        finalize_musig2_taproot_input(
            ...
            input_index,
            TapSighashType::Single,
            self.connector_a1.generate_taproot_spend_info(),
        );
    }
    ...
    pub fn add_input_output(&mut self, input_script_index: u32, output_script_pubkey: ScriptBuf) {
        ...
        let taproot_spend_info = self.connector_a0.generate_taproot_spend_info();
