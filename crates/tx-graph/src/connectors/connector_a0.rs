...
use crate::{constants::NUM_BLOCKS_PER_3_DAYS, utils::num_blocks_per_network};

#[derive(Debug, Serialize, Deserialize, Eq, PartialEq, Clone)]
pub struct ConnectorA0 {
    pub network: Network,
...
impl ConnectorA0 {
    pub fn new(
        ...
        ConnectorA0 {
            ...
            num_blocks_timelock_0: num_blocks_per_network(network, NUM_BLOCKS_PER_3_DAYS),
        }
    }
...
impl TaprootConnector for ConnectorA0 {
