...
impl AwsS3 {
    pub fn new() -> Option<Self> {
        dotenvy::dotenv().ok();
        let access_key = dotenvy::var("BRIDGE_AWS_ACCESS_KEY_ID");
        let secret = dotenvy::var("BRIDGE_AWS_SECRET_ACCESS_KEY");
        let region = dotenvy::var("BRIDGE_AWS_REGION");
        let bucket = dotenvy::var("BRIDGE_AWS_BUCKET");
